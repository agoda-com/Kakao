...
[kakao](../../index.html) / [com.agoda.kakao](../index.html) / [ImageViewAssertions](.)

# ImageViewAssertions

`interface ImageViewAssertions : `[`BaseAssertions`](../-base-assertions/index.html)
...
| [KImageView](../-k-image-view/index.html) | `class KImageView : `[`KBaseView`](../-k-base-view/index.html)`<`[`KImageView`](../-k-image-view/index.html)`>, ImageViewAssertions`<br>View with BaseActions and ImageViewAssertions |
