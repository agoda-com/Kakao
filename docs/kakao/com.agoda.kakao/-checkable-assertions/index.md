...
[kakao](../../index.html) / [com.agoda.kakao](../index.html) / [CheckableAssertions](.)

# CheckableAssertions

`interface CheckableAssertions : `[`BaseAssertions`](../-base-assertions/index.html)

Provides checkable based assertions for views

### Inherited Properties

| [view](../-base-assertions/view.html) | `abstract val view: ViewInteraction` |

### Functions

| [isChecked](is-checked.html) | `open fun isChecked(): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)<br>Checks if the view is checked |
| [isNotChecked](is-not-checked.html) | `open fun isNotChecked(): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)<br>Checks if the view is not checked |
