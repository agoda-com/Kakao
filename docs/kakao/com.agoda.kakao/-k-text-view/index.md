...
[kakao](../../index.html) / [com.agoda.kakao](../index.html) / [KTextView](.)

# KTextView

`class KTextView : `[`KBaseView`](../-k-base-view/index.html)`<KTextView>, `[`TextViewAssertions`](../-text-view-assertions/index.html)
...
| [&lt;init&gt;](-init-.html) | `KTextView(function: `[`ViewBuilder`](../-view-builder/index.html)`.() -> `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)`)`<br>`KTextView(parent: Matcher<`[`View`](https://developer.android.com/reference/android/view/View.html)`>, function: `[`ViewBuilder`](../-view-builder/index.html)`.() -> `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)`)`<br>`KTextView(parent: DataInteraction, function: `[`ViewBuilder`](../-view-builder/index.html)`.() -> `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)`)` |
