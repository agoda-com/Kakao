[kakao](../../index.md) / [com.agoda.kakao](../index.md) / [KTextView](.)

# KTextView

`class KTextView : `[`KBaseView`](../-k-base-view/index.md)`<KTextView>, `[`TextViewActions`](../-text-view-actions/index.md)`, `[`TextViewAssertions`](../-text-view-assertions/index.md)
