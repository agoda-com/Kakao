[kakao](../../index.md) / [com.agoda.kakao.pager](../index.md) / [ViewPagerAssertions](./index.md)

# ViewPagerAssertions

`interface ViewPagerAssertions : `[`BaseAssertions`](../../com.agoda.kakao.common.assertions/-base-assertions/index.md)
...
| Name | Summary |
|---|---|
| [KViewPager](../-k-view-pager/index.md) | `class KViewPager : `[`KBaseView`](../../com.agoda.kakao.common.views/-k-base-view/index.md)`<`[`KViewPager`](../-k-view-pager/index.md)`>, `[`SwipeableActions`](../../com.agoda.kakao.common.actions/-swipeable-actions/index.md)`, `[`ViewPagerAssertions`](./index.md)<br>View with SwipeableActions and ViewPagerAssertions |
