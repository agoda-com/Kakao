[kakao](../../index.md) / [com.agoda.kakao.tabs](../index.md) / [TabLayoutAssertions](./index.md)

# TabLayoutAssertions

`interface TabLayoutAssertions : `[`BaseAssertions`](../../com.agoda.kakao.common.assertions/-base-assertions/index.md)
...
| Name | Summary |
|---|---|
| [KTabLayout](../-k-tab-layout/index.md) | `class KTabLayout : `[`KBaseView`](../../com.agoda.kakao.common.views/-k-base-view/index.md)`<`[`KTabLayout`](../-k-tab-layout/index.md)`>, `[`TabLayoutActions`](../-tab-layout-actions/index.md)`, `[`TabLayoutAssertions`](./index.md)<br>View with TabLayoutActions and TabLayoutAssertions |
