[kakao](../../index.md) / [com.agoda.kakao.picker.date](../index.md) / [DatePickerAssertion](./index.md)

# DatePickerAssertion

`interface DatePickerAssertion : `[`BaseActions`](../../com.agoda.kakao.common.actions/-base-actions/index.md)
...
| Name | Summary |
|---|---|
| [KDatePicker](../-k-date-picker/index.md) | `class KDatePicker : `[`KBaseView`](../../com.agoda.kakao.common.views/-k-base-view/index.md)`<`[`KDatePicker`](../-k-date-picker/index.md)`>, `[`DatePickerAction`](../-date-picker-action/index.md)`, `[`DatePickerAssertion`](./index.md)<br>View for interact with default date picker |
