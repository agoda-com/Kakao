[kakao](../index.md) / [com.agoda.kakao.toolbar](index.md) / [ToolbarViewActions](./-toolbar-view-actions.md)

# ToolbarViewActions

`interface ToolbarViewActions : `[`BaseActions`](../com.agoda.kakao.common.actions/-base-actions/index.md)
